      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-1">
          {toolbarButtons.map((btn) => (
            <button
              ...
              title={btn.title}
              onClick={btn.action}
              className="px-2 py-1 text-xs border border-gray-300 rounded hover:bg-gray-100 min-w-[28px]"
            >
              {btn.label}
            </button>
          ))}
        ...
        <div className="flex text-xs">
          <button
            ...
            className={`px-2 py-1 rounded-l border ${!preview ? 'bg-blue-600 text-white border-blue-600' : 'border-gray-300 hover:bg-gray-100'}`}
          >
            編集
          </button>
          <button
            ...
            className={`px-2 py-1 rounded-r border-t border-r border-b ${preview ? 'bg-blue-600 text-white border-blue-600' : 'border-gray-300 hover:bg-gray-100'}`}
          >
            プレビュー
          </button>
        </div>
